...
- клиентский поиск по значениям строк и фильтрацию по колонке с условиями `Содержит`, `Равно`, `Не равно`, `Пусто`, `Заполнено`;
...
- В таблице ресурса поиск и фильтры применяются к уже загруженному ответу `GET /api/<resource>`, показывают счетчик найденных строк и не меняют серверный контракт.
