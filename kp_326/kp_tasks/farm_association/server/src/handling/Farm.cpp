...
fasc::server::controllers::dto::FarmKeyDto keyFrom(
    const fasc::server::core::HttpRequest& request) {
  fasc::server::controllers::dto::FarmKeyDto key;
...
FarmHandler::FarmHandler(fasc::server::controllers::http::FarmHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse FarmHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse FarmHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse FarmHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse FarmHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse FarmHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
...
void registerFarmRoutes(fasc::server::core::Server& server,
