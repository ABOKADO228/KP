...
fasc::server::controllers::dto::EmploymentStatusKeyDto keyFrom(
    const fasc::server::core::HttpRequest& request) {
  fasc::server::controllers::dto::EmploymentStatusKeyDto key;
...
EmploymentStatusHandler::EmploymentStatusHandler(fasc::server::controllers::http::EmploymentStatusHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse EmploymentStatusHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse EmploymentStatusHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse EmploymentStatusHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse EmploymentStatusHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse EmploymentStatusHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
