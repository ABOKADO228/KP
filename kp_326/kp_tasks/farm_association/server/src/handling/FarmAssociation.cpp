...
fasc::server::controllers::dto::FarmAssociationKeyDto keyFrom(
    const fasc::server::core::HttpRequest& request) {
  fasc::server::controllers::dto::FarmAssociationKeyDto key;
...
FarmAssociationHandler::FarmAssociationHandler(fasc::server::controllers::http::FarmAssociationHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse FarmAssociationHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse FarmAssociationHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse FarmAssociationHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse FarmAssociationHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse FarmAssociationHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
