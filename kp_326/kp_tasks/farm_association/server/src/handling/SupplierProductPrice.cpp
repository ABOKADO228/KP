...
fasc::server::controllers::dto::SupplierProductPriceKeyDto keyFrom(
    const fasc::server::core::HttpRequest& request) {
  fasc::server::controllers::dto::SupplierProductPriceKeyDto key;
...
SupplierProductPriceHandler::SupplierProductPriceHandler(fasc::server::controllers::http::SupplierProductPriceHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse SupplierProductPriceHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse SupplierProductPriceHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse SupplierProductPriceHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse SupplierProductPriceHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse SupplierProductPriceHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
