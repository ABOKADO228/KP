...
fasc::server::controllers::dto::SalesRequisitionKeyDto keyFrom(
    const fasc::server::core::HttpRequest& request) {
  fasc::server::controllers::dto::SalesRequisitionKeyDto key;
...
SalesRequisitionHandler::SalesRequisitionHandler(fasc::server::controllers::http::SalesRequisitionHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse SalesRequisitionHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse SalesRequisitionHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse SalesRequisitionHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse SalesRequisitionHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse SalesRequisitionHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
