...
fasc::server::controllers::dto::IdentityDocumentTypeKeyDto keyFrom(
    const fasc::server::core::HttpRequest& request) {
  fasc::server::controllers::dto::IdentityDocumentTypeKeyDto key;
...
IdentityDocumentTypeHandler::IdentityDocumentTypeHandler(fasc::server::controllers::http::IdentityDocumentTypeHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse IdentityDocumentTypeHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse IdentityDocumentTypeHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse IdentityDocumentTypeHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse IdentityDocumentTypeHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse IdentityDocumentTypeHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
