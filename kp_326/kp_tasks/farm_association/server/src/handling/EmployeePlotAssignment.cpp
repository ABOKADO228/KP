...
fasc::server::controllers::dto::EmployeePlotAssignmentKeyDto keyFrom(
...
EmployeePlotAssignmentHandler::EmployeePlotAssignmentHandler(fasc::server::controllers::http::EmployeePlotAssignmentHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse EmployeePlotAssignmentHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse EmployeePlotAssignmentHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse EmployeePlotAssignmentHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse EmployeePlotAssignmentHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse EmployeePlotAssignmentHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
