...
fasc::server::controllers::dto::FarmOwnerKeyDto keyFrom(
    const fasc::server::core::HttpRequest& request) {
  fasc::server::controllers::dto::FarmOwnerKeyDto key;
...
FarmOwnerHandler::FarmOwnerHandler(fasc::server::controllers::http::FarmOwnerHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse FarmOwnerHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse FarmOwnerHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse FarmOwnerHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse FarmOwnerHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse FarmOwnerHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
