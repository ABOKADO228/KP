...
fasc::server::controllers::dto::PersonKeyDto keyFrom(
    const fasc::server::core::HttpRequest& request) {
  fasc::server::controllers::dto::PersonKeyDto key;
...
PersonHandler::PersonHandler(fasc::server::controllers::http::PersonHttpController& controller)
    : controller_(controller) {}

fasc::server::core::HttpResponse PersonHandler::list(const fasc::server::core::HttpRequest&) {
  return responseFrom(controller_.list(), 200);
}

fasc::server::core::HttpResponse PersonHandler::load(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse PersonHandler::create(
    const fasc::server::core::HttpRequest& request) {
  return responseFrom(controller_.create(request.body), 201);
}

fasc::server::core::HttpResponse PersonHandler::update(
    const fasc::server::core::HttpRequest& request) {
  try {
...
fasc::server::core::HttpResponse PersonHandler::erase(
    const fasc::server::core::HttpRequest& request) {
  try {
