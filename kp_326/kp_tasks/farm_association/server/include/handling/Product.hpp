...
/// Handler таблицы product.
class ProductHandler {
public:
  /// Создает handler таблицы.
  ///@param controller HTTP controller таблицы.
  explicit ProductHandler(fasc::server::controllers::http::ProductHttpController& controller);
...
private:
  fasc::server::controllers::http::ProductHttpController& controller_;
};

/// Registers HTTP routes for the Product table.
