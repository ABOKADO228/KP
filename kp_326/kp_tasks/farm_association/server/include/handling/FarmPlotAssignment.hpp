...
/// Handler таблицы farm_plot_assignment.
class FarmPlotAssignmentHandler {
public:
  /// Создает handler таблицы.
  ///@param controller HTTP controller таблицы.
  explicit FarmPlotAssignmentHandler(fasc::server::controllers::http::FarmPlotAssignmentHttpController& controller);
...
private:
  fasc::server::controllers::http::FarmPlotAssignmentHttpController& controller_;
};

/// Registers HTTP routes for the FarmPlotAssignment table.
